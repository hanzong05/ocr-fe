...
export default function Form90({ fields, editing, onChange }: Props) {
  ...
  return (
    <div
      style={{ fontFamily: "Arial, sans-serif", fontSize: 10, color: "#111" }}
    >
      {/* TOP BAR */}
      <div
        style={{
      ...
      >
        <div style={{ fontSize: 8, color: "#333", minWidth: 120 }}>
      ...
      {/* META ROWS */}
      {[
        ["Province:", "province", 200, "Registry No.:", "registry_no", 100],
        ...
        >
          <span>
            ...
            {key1 ? (
              editing ? (
                <input
                  value={fields[key1 as string] || ""}
                  onChange={(e) => onChange(key1 as string, e.target.value)}
                  style={{
                    border: "none",
                    borderBottom: "1px solid #333",
                    outline: "none",
                    minWidth: w1 as number,
                    fontSize: 9,
                  }}
                />
              ) : (
                <span style={{ ...fieldLine, minWidth: w1 as number }}>
                  {fields[key1 as string]}
                </span>
              )
            ) : (
          ...
          {lbl2 && (
            <span>
              ...
              {key2 ? (
                editing ? (
                  <input
                    value={fields[key2 as string] || ""}
                    onChange={(e) => onChange(key2 as string, e.target.value)}
                    style={{
                      border: "none",
                      borderBottom: "1px solid #333",
                      outline: "none",
                      minWidth: w2 as number,
                      fontSize: 9,
                    }}
                  />
                ) : (
                  <span style={{ ...fieldLine, minWidth: w2 as number }}>
                    {fields[key2 as string]}
                  </span>
                )
              ) : (
                <span style={fieldLine}>&nbsp;</span>
          ...
          <tr>
            ...
            <td style={td}>
              ...
              {editing ? (
                <input
                  value={fields.pom || ""}
                  onChange={(e) => onChange("pom", e.target.value)}
                  style={inp()}
                />
              ) : (

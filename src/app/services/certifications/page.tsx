...
export default function CertificationsPage() {
  ...
  async function proceed() {
    ...
    try {
      ...
      const assembled = assembleFields(data.form_class as FormClass, data.fields)
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ background: 'white', borderRadius: 16, padding: 40, boxShadow: '0 4px 24px rgba(0,0,0,0.08)', width: '100%', maxWidth: 560 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 6, color: 'var(--navy)' }}>CERTIFICATIONS</h2>
          <p style={{ color: 'var(--gray)', fontSize: 14, marginBottom: 24 }}>Form 1A, Form 2A, Form 3A</p>
